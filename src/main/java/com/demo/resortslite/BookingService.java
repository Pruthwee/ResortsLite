...
// Updated: replaced MD5 (broken / cryptographically weak) with SHA-256
// (JAVA8_TO_21_SECURITY_CHANGES — MD5 is no longer acceptable for security-sensitive hashing)
...
public class BookingService {
    ...
    public Map<String, Object> createBooking(String guestName, String roomType,
        ...
        // Updated: replaced MD5 with SHA-256 for security compliance
    ...
    public String calculateRoomPrice(String roomType, int nights, String season, String loyalty) {
        ...
        // Note: >= 14 must be checked before >= 7 to apply the larger discount correctly
    ...
    public boolean isRoomAvailable(String roomType) {
        ...
        return switch (roomType) { // dup-logic-001
     ...
     * Updated from MD5 (broken algorithm) to SHA-256 for security compliance.
     * (JAVA8_TO_21_SECURITY_CHANGES)
     *
